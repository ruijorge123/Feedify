/**
 * Old self-service Brand DNA vocabulary.
 *
 * Superseded by brandDna.js for the agency model, but the admin-only Brand Kit
 * screen still edits profiles created under the old schema, so the lists have to
 * stay resolvable. Nothing new should import this.
 */
